...
[^1]: In the model, `a`, `b`, and `c` are coefficients where variables `y1`, `y2`, `y3`, and `y4` are indicators of the latent variable `dem60`.
...
[^2]: The text inside `[]` should be replaced with actual variable and model name.
