---
title: "tspa-diagnostic-plot-vignette"
author: "Jimmy Zhang"
date: 'r Sys.Date()'
output: 
...
# Residual Plot
resid_tspa1 <- as.data.frame(resid(tspa_fit_1, "obs"))
plot(resid_tspa1$fs_dem60, fs_dat$fs_ind60, main = "Residual Plot")
```
...
# Residual Plot
resid_tspa2 <- as.data.frame(resid(tspa_fit_2, "obs"))
plot(resid_tspa2$fs_dem60, fs_dat$fs_ind60)
plot(resid_tspa2$fs_dem65, fs_dat$fs_ind60)
plot(resid_tspa2$fs_dem65, fs_dat$fs_dem60)

# Partial Plot
plot(resid_tspa2$fs_ind60, resid_tspa2$fs_dem65)
plot(resid_tspa2$fs_dem60, resid_tspa2$fs_dem65)
```
