...
(fsT_cor <- fsTov_corrected(tspa_fit, vfsLT = vldev, which_free = c(1, 4, 5, 7)))
...
(fsT_j <- 
  fsTov(sem_fit)[c("dem60~ind60", "ind60~~ind60", "dem60~~dem60"),
...
fsTov(tspa_fit2)
# Adjusted covariance
(fsT2_cor <- fsTov_corrected(tspa_fit2, vfsLT = vldev_joint))
# Corrected standard errors
sqrt(diag(fsT2_cor))
```
...
# Unadjusted covariance
fsTov(tspa_fit)[c(1:6, 10:15), c(1:6, 10:15)]
# Adjusted covariance
fsTov_corrected(tspa_fit, vfsLT = vldev)[c(1:6, 10:15), c(1:6, 10:15)]
```
