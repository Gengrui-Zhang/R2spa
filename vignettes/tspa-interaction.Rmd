...
model_rapi <- "
              tvalue =~ tsum_centered
              sources =~ ssum_centered
              tip =~ tips_sum_centered
              product_ind =~ int_centered
              
              # Constrain the errors
              tsum_centered ~~ 1.762796*tsum_centered
              ssum_centered ~~ 3.625876*ssum_centered
              tips_sum_centered ~~ 2.805245 *tips_sum_centered
              int_centered ~~ 66.87365 *int_centered
