...
'
summary(indprod_analysis(data = df,
                         model = model))
```
...
<<<<<<< HEAD
fs_tvalue ~~ 0.1219141^2 * fs_tvalue
fs_sources ~~ 0.2024207^2 * fs_sources
fs_int ~~ 0.2419617^2 * fs_int
fs_tip ~~ 0.694483^2 * fs_tip
=======
fs_tvalue ~~ 0.1219141 * fs_tvalue
fs_sources ~~ 0.2024207 * fs_sources
fs_int ~~ 0.3490127 * fs_int
fs_tip ~~ 0.694483 * fs_tip
>>>>>>> c79fcefe8675551587d32bf4ff869df4902d6ce5
# regressions
tip ~ tvalue + sources + int
'
