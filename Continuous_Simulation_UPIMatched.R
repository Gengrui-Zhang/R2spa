...
# Run 2000 replications
 ...
 sim_01222024 <- runSimulation(design = DESIGNFACTOR,
                            replications = 2000,
                            generate = GenData,
                            analyse = extract_res,
                            ...
                            save = TRUE,
                            save_results = TRUE,
                            filename = "sim_01222024",
                            parallel = TRUE,
                            ncores = min(4L, parallel::detectCores() - 1))

# Summarize the results

 sim_results <- sim_01222024 %>%
 ...
 write_csv(sim_results, "sim_01222024.csv")

# Plot the results

 sim_plots <- read.csv("sim_01222024.csv")
 # # Bias
 # sim_plots %>%
