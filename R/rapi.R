rapi <- function (model, data) {
  ...
  evars_int <- lambda_sum[pairs$inter_pair_1][[1]]^2*evars_sum[pairs$inter_pair_1][[2]] +
    lambda_sum[pairs$inter_pair_1][[2]]^2*evars_sum[pairs$inter_pair_1][[1]] +
    prod(unlist(evars_sum[pairs$inter_pair_1]))
